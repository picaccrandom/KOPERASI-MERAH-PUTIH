...
<div class="min-h-screen bg-cover bg-fixed" style="background-image: url('{{ asset('img/background-klinik.png') }}');">
    <div class="bg-blue-900/20 backdrop-blur-md min-h-screen p-10">
        ...
        <div class="flex justify-between items-end mb-10 border-l-8 border-blue-600 pl-6">
            ...
            <a href="{{ route('klinik.pendaftaran') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-2xl font-black shadow-xl transition-all transform hover:scale-105 uppercase tracking-widest flex items-center">
        ...
        <div class="bg-white/95 rounded-3xl shadow-2xl overflow-hidden border border-white/50">
            <div class="bg-blue-600 px-8 py-4 flex justify-between items-center text-white font-black uppercase tracking-widest">
                            ...
                            <td class="py-4 text-center">
                                ...
                                @else
                                    ...
                                    <div class="flex flex-col items-center gap-2">
                                        <span class="inline-block px-6 py-1 rounded-xl text-xs font-black bg-green-100 text-green-600 uppercase border border-green-200 shadow-sm">
                                            <i class="fas fa-check-circle mr-1"></i> Selesai
                                        </span>
                                        {{-- Link Lihat Detail Rekam Medis --}}
                                        <a href="{{ route('klinik.show', $a->id) }}" class="text-blue-600 hover:text-blue-800 text-[10px] font-black uppercase tracking-tighter underline decoration-2 underline-offset-4 transition-all">
