...
<div class="menu-wrapper">
    <div class="menu-grid">
        ...
        $menus = [
            ...
            ['icon' => 'fa-warehouse', 'title' => 'Gudang', 'color' => 'linear-gradient(135deg, #6366f1, #4338ca)', 'link' => route('gudang.index'), 'sub' => 'Inventory Control'],
            ...
            ['icon' => 'fa-user-gear', 'title' => 'Adm. Sistem', 'color' => 'linear-gradient(135deg, #475569, #1e293b)', 'link' => 'javascript:void(0);', 'sub' => 'Control Panel', 'id' => 'btn-adm-sistem'],
        ];
        @endphp
